...
import type { Manifest, PackageFiles } from "../../../runner/contract.ts"
...
export function packageFiles(source: Source, draft: PackageDraft, evidence: Evidence[]): PackageFiles {
  ...
  const packageJson = Schema.decodeSync(Schema.fromJsonString(Schema.Record(Schema.String, Schema.Unknown)))(runtimeFile("package.json"))
